...
For guidance on setting attributes, select *Show Attributes Documentation* from the Window menu. Note that some of the links in the documentation open external sites. To return to the attributes documentation page, select the Overview button below the title bar.
