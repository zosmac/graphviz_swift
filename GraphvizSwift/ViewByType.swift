...
//                min(size.width/image.size.width, size.height/image.size.height)
                //                    let contentMode: ContentMode = image.size.width > image.size.height ? .fit : .fill
                let contentMode: ContentMode = zoomScale == 0.0 ? .fit : .fill
                //                    ViewImage(zoomScale: $zoomScale, size: size, imageSize: image.size)
